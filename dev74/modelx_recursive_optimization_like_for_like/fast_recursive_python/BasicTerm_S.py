...
def _calc_inflation_rate(rt):
    """Inflation rate"""
    return 0.01

def fr_inflation_rate(rt):
    c = rt.cache[12]
    key = None
    if key in c:
        return c[key]
