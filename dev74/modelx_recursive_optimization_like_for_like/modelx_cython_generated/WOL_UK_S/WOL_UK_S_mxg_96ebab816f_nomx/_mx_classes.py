...
class _c_Projection(_mx_sys.BaseSpace):
    ...
    def __init__(self, parent):
        ...
        self._has_sex = False
        self._v_smoker = None
        self._has_smoker = False
        self._v_sum_assured = None
        self._has_sum_assured = False
        self._v_premium_mth = None
        self._has_premium_mth = False
        self._v_escalation = None
        self._has_escalation = False
        self._v_cessation_mths = None
        self._has_cessation_mths = False
        self._v_moratorium_mths = None
        self._has_moratorium_mths = False
        self._v_adb_multiplier = None
        self._has_adb_multiplier = False
        self._v_pu_variant = None
        self._has_pu_variant = False
        ...
        self._v_mort_loading = None
        self._has_mort_loading = False
        self._v_mort_improve_factor = {}
        self._v_mort_rate = {}
        self._v_mort_rate_mth = {}
        self._v_esc_cover_step = None
        self._has_esc_cover_step = False
        self._v_esc_prem_step = None
        self._has_esc_prem_step = False
        self._v_cover_pp = {}
        self._v_premium_pp = {}
        self._v_prem_cum_pp = {}
        self._v_in_moratorium = {}
        self._v_payments_made = {}
        self._v_payments_expected = None
        self._has_payments_expected = False
        self._v_pu_eligible = {}
        self._v_crossover_mth = None
        self._has_crossover_mth = False
        ...
        self._v_pols_exit = {}
        self._v_pols_convert = {}
        self._v_pols_lapse = {}
        self._v_pols_maturity = {}
        self._v_benefit_pp = {}
        self._v_premiums = {}
        self._v_claims = {}
        self._v_expense_acq_pp = None
        self._has_expense_acq_pp = False
        self._v_expense_maint_pp = None
        self._has_expense_maint_pp = False
        ...
        self._v_check_truncation = None
        self._has_check_truncation = False
    ...
    def _mx_copy_refs(self, base, base_root):
        ...
        self.mort_loading_o50 = base.mort_loading_o50
        self.mort_loading_uw = base.mort_loading_uw
        self.mort_improvement = base.mort_improvement
        self.acc_share = base.acc_share
        self.suicide_share = base.suicide_share
        self.suicide_mths = base.suicide_mths
        self.rpi_rate = base.rpi_rate
        self.esc_fixed_cover = base.esc_fixed_cover
        self.esc_fixed_prem = base.esc_fixed_prem
        self.esc_rpi_cover_cap = base.esc_rpi_cover_cap
        self.esc_rpi_prem_mult = base.esc_rpi_prem_mult
        self.esc_rpi_prem_cap = base.esc_rpi_prem_cap
        self.esc_take_up = base.esc_take_up
        self.lapse_crossover_beta = base.lapse_crossover_beta
        self.expense_acq_o50 = base.expense_acq_o50
        self.expense_acq_uw = base.expense_acq_uw
        self.expense_maint_o50 = base.expense_maint_o50
        self.expense_maint_uw = base.expense_maint_uw
    ...
    def prem_cum_pp(self, t):
        if t in self._v_prem_cum_pp:
    ...
    def in_moratorium(self, t):
        if t in self._v_in_moratorium:
    ...
    def payments_made(self, t):
        if t in self._v_payments_made:
    ...
    def pu_eligible(self, t):
        if t in self._v_pu_eligible:
    ...
    def pu_benefit(self, t):
        if t in self._v_pu_benefit:
    ...
    def pols_exit(self, t):
        if t in self._v_pols_exit:
    ...
    def pols_convert(self, t):
        if t in self._v_pols_convert:
